...
public class GuestbookController {
	...
	public String list(@RequestParam(name="start", required=false, defaultValue="0") int start,
					   ModelMap model, @CookieValue(value="count", defaultValue="0", required=true) String value, HttpServletResponse response, HeaderInfo headerInfo) {
		...
		//		String value = null;
//		boolean find = false; //처음요청이 들어왔을때
//		
//		//클라이언트가 들고온 쿠키가 있는지 검사하고
//		//있다면 내가원하는 쿠키인지 검사하는 코드
...
//		}
		...
		model.addAttribute("cookieCount", value);//jsp에서 사용하기 위해 붙인것
